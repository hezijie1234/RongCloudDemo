...
public class GroupMemberDao extends AbstractDao<GroupMember, Long> {
    ...
    public static class Properties {
        ...
        public final static Property PortraitUri = new Property(4, String.class, "portraitUri", false, "PORTRAIT_URI");
        ...
        public final static Property GroupPortraitUri = new Property(10, String.class, "groupPortraitUri", false, "GROUP_PORTRAIT_URI");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GROUP_MEMBER\" (" + //
                ...
                "\"NAME\" TEXT," + // 3: name
                "\"PORTRAIT_URI\" TEXT," + // 4: portraitUri
                ...
                "\"GROUP_PORTRAIT_URI\" TEXT);"); // 10: groupPortraitUri
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, GroupMember entity) {
        ...
        if (groupPortraitUri != null) {
            stmt.bindString(11, groupPortraitUri);
        }
    }
    ...
    public GroupMember readEntity(Cursor cursor, int offset) {
        GroupMember entity = new GroupMember( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // portraitUri
            ...
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10) // groupPortraitUri
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, GroupMember entity, int offset) {
        ...
        entity.setPortraitUri(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
        ...
        entity.setGroupPortraitUri(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
     }
