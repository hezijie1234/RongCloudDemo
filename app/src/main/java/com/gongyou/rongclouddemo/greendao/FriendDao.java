...
public class FriendDao extends AbstractDao<Friend, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Letters = new Property(9, String.class, "letters", false, "LETTERS");
        public final static Property NameSpelling = new Property(10, String.class, "nameSpelling", false, "NAME_SPELLING");
        public final static Property DisplayNameSpelling = new Property(11, String.class, "displayNameSpelling", false, "DISPLAY_NAME_SPELLING");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FRIEND\" (" + //
                ...
                "\"LETTERS\" TEXT," + // 9: letters
                "\"NAME_SPELLING\" TEXT," + // 10: nameSpelling
                "\"DISPLAY_NAME_SPELLING\" TEXT);"); // 11: displayNameSpelling
    }
    ...
    public Friend readEntity(Cursor cursor, int offset) {
        Friend entity = new Friend( //
            ...
            cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9), // letters
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // nameSpelling
            cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11) // displayNameSpelling
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Friend entity, int offset) {
        ...
        entity.setLetters(cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
        entity.setNameSpelling(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
        entity.setDisplayNameSpelling(cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11));
     }
